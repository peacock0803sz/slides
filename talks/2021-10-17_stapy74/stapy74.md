...
![w:430](images/QRCode.png)

- 資料は公開済みです
    - QRコードまたはSpeaker Deckから閲覧できます
    - <https://speakerdeck.com/peacock0803sz/stapy74>
- 資料は英語になります。説明は日本語です
- EuroPython 2021での45分版がYouTubeにあります
    - **"EuroPython 2021 Yoichi Takai"** で検索
    - <https://youtu.be/8HEYko-o63I>
- サンプルコードはPEP8準拠ではありません
...
- `dict`, `frozenset`, `list`, `set`, `tuple`
    ...
    - ref: [What’s New In Python 3.9 (Offical doc)](https://docs.python.org/3.9/whatsnew/3.9.html#type-hinting-generics-in-standard-collections)
